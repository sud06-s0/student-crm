      ...
      <div className="nova-main">
        ...
        <div className="nova-header">
          <div className="header-left">
            <h1>Hot Leads</h1>
            <span className="total-count">Hot Leads {leadsData.length}</span>
              ...
              {!loading && displayLeads.length > 0 ? (
                ...
                <tr>
                  <td colSpan="9" className="no-data">
                    {searchTerm ? 'No hot leads found for your search.' : 'No hot leads available. Hot leads will appear here as they progress through the stages.'}
                  </td>
                </tr>
              ) : null}
            </tbody>
